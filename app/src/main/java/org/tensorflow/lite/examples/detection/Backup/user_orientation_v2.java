...
//
//public class user_orientation_v2 implements SensorEventListener{
...
//    public user_orientation_v2(SensorManager sm, Sensor gyro, Sensor acc, Sensor rotation, TextToSpeech tts, StoreManagement store_m){
//        this.sm = sm;
//        this.gyro = gyro;
//        this.acc = acc;
...
//            count++;
//            if (check_filter(filter, -1) && time_interval && !explain_ori &&  (ble.getsection() == 0 && ble.get_sector() == 10)){
//                explain_ori = true;
...
//                ori_init_count++;
//                //tts.speak("앞으로 두 걸음 이동해주세요.", TextToSpeech.QUEUE_FLUSH, null);
//            }
//            else {
//                azimuth = azimuth - calib_ori;
//
//                if(azimuth < 0)
//                    azimuth =  (azimuth + 360*3) % 360;
//
