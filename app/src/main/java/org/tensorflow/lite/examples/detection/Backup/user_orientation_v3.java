...
//
//public class user_orientation_v3 implements SensorEventListener{
...
//    public user_orientation_v3(SensorManager sm, Sensor gyro, Sensor acc, Sensor rotation, TextToSpeech tts, StoreManagement store_m){
//        this.sm = sm;
//        this.gyro = gyro;
//        this.acc = acc;
