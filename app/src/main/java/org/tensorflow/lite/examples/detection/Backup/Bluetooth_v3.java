...
//
//import org.tensorflow.lite.examples.detection.navi.section;
...
//    private int[] mac_change_1 = {3, 6, 9, 11};
//
//
...
//
//
//    public Bluetooth_v3(BluetoothAdapter adapter, user_orientation user_ori, TextToSpeech tts, StoreManagement store_m){
...
//        this.mac_index = 0;
//
//        //Macs = MAC_info[Integer.valueOf(section)][0];
//
...
//
//        org.tensorflow.lite.examples.detection.navi.section service = retrofit.create(section.class);
...
//                                        user_ori.change_cali_AtC(-90);
//                                        beacon_change(1, 0);
//                                        section="1";
//                                        mac_index = 0;
//                                    } else {
//                                        beacon_change(0, ++mac_index);
//                                    }
//                                }
//                                if (section.equals("1")) {
//                                    if (map_index == 5) {
...
//                                        section = "1";
//                                    } else {
//                                        beacon_change(2, ++mac_index);
//                                    }
//                                }
//                                Log.e("change", String.valueOf(mac_index));
//                            }
//                        }
//
//                    }
