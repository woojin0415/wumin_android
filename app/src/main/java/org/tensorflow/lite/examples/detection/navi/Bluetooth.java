...
public class Bluetooth {
    ...
    public void set_wi(){
        ...
        wi.set_work(0,1, "화성 풍경: 가림막", "<화성 풍경-가림막> 은 작가가 실제로 화성의 봉담택지지구로 이주한 후에 본 병점역 앞의 풍경을 담고 있습니다. 작가가 작업을 구상하던 당시 병점역 앞은 개발구역으로 지정되어 가림막으로 둘러싸인 황량한 땅이었습니다. 지금은 걸을 수 없는 땅이 되었지만, 주위의 느티나무들과 근처에 있는 용주사와 융건릉은 한때 이곳이 장소성을 지닌 곳이라는 것을 보여줍니다. \n" +
                "\n" +
        ...
        wi.set_work(0,2, "화성 놀이터", "아파트 안에 있는 놀이터와 정자는 특정시간대에 아이들이 우글우글 모이다가 갑자기 모두 다 사라지는 신비한 일이 일어나는 곳입니다. 시간대에 따라 놀이터에 모이는 아이들의 연령대는 모두 다르고 택지 지구 안에서 아이들이 놀 만한 곳은 딱히 없어 보입니다. 오래전부터 마을 사람들이 모여 쉬는 곳이었던 정자는 사각, 육각, 팔각 형태도 다양합니다. 이국적인 놀이터와 한국적인 정자의 만남은 아무런 개연성도 없어보입니다.\n" +
                "\n" +
        ...
        wi.set_work(0,3, "화성 풍경: 흙", "<화성 풍경-흙>은 앞서 보았던 <화성 풍경-가림막>과 대칭되는 작품입니다. 거대하게 쌓여진 흙 아래로 파란색 캔들과 공사현장에서 나온 쓰레기들이 그림 아래를 가득 채우고 있습니다. 번듯하게 완성된 신도시의 풍경 가림막 뒤에는 이렇든 개발 과정에서 생긴 삶의 풍경이 남아있습니다. 작가는 현장을 다니며 개발과정에서 일어난 현상들에 주목하고 도시 이면의 모습을 그림으로 담아왔습니다. \n");
        wi.set_work(0,4, "주차장", "서버비아는 자동차 위주의 생활양식으로 주로 미국 교외지역에서 발달했습니다. 작가는 유학시절 디트로이드에서 보았던 서버비아 형태의 대형마트를 화성에서도 보게 되었습니다. 서울의 대형마트들은 대중교통을 바로 이용할 수 있거나 지하주차장이 있는데, 이곳은 출퇴근용 차가 한 대 있고 동네를 다닐 때 쓰는 소형차가 세컨드카로 있는 경우가 많습니다. 작가 본인에게는 낯설었던 택지지구의 삶이 아이들에게는 자연스러운 풍경이 되어 새로운 장소성을 경험하리라고 작가는 생각했습니다. 매 순간마다 변화하는 아이들의 모습과 어디서나 동일한 모습을 보이는 주차장의 풍경은 서로 대비되어 보입니다. \n");
